...
if __name__ == "__main__":
    ...
    #标签数据
    fname = 'E:/medimg/LUNA16/annotations.csv'
    ...
    for i in range(len(data)):
        ...
        im1 = im1.convert("RGB")
        im11 = Image.fromarray(imgLabel1)
        im11 = im11.convert("RGB")
        im1.save('VOCdevkit/VOC2019/JPEGImages/{:04d}.png'.format(count+1))
        im11.save('VOCdevkit/VOC2019/OriginalImages/{:04d}.png'.format(count + 1))
        count = count + 1
        img, mask = getLungMask(imgLabel2)
        im2 = Image.fromarray(img)
        im2 = im2.convert("RGB")
        im22 = Image.fromarray(imgLabel2)
        im22 = im22.convert("RGB")
        im2.save('VOCdevkit/VOC2019/JPEGImages/{:04d}.png'.format(count+1))
        im22.save('VOCdevkit/VOC2019/OriginalImages/{:04d}.png'.format(count + 1))
        count = count + 1
        img, mask = getLungMask(imgLabel3)
        im3 = Image.fromarray(img)
        im3 = im3.convert("RGB")
        im33 = Image.fromarray(imgLabel3)
        im33 = im33.convert("RGB")
        im3.save('VOCdevkit/VOC2019/JPEGImages/{:04d}.png'.format(count+1))
        im33.save('VOCdevkit/VOC2019/OriginalImages/{:04d}.png'.format(count + 1))
        count = count + 1
