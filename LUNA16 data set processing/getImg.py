...
"""
    ...
    for prop in regions:
        B = prop.bbox
        if B[2]-B[0]<492 and B[3]-B[1]<492 and B[0]>20 and B[2]<492:
    ...
    mask = cv2.dilate(mask, np.ones((40, 40)))#膨胀填充空洞
    ...
    ax[0,1].imshow(mask,cmap='gray')  # CT切片灰度图
